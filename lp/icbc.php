...
$metaDesc =  "Our ".$city." Car and Auto Accident Personal Injury Lawyer is here to help you with your ICBC Personal Injury Claim.";

$page = "home";
$keywords = Array();
$keywords = "injury, personal injury, lawyer, ICBC, car accident, auto accident, driver, pedestrian, damages, passenger, claim";
...
<h2><?= $city; ?></h2>
    ...
    <script type="text/javascript">insertVideoPlayer( "/videoPlayer/videoPlayer.swf", 350, 300, "../videos/lp/icbc.flv", "000000", false, "/images/playVideo.png", "/images/pauseVideo.png" );</script>
...
<div class="leftContent">
  ...
  <h1><?= $city; ?> ICBC Personal Injury and Car Accident Lawyers</h1>
...
<p>No matter what your injuries, there is legal information that you need to know, and you need to get it from a personal injury lawyer. One who is familiar with ICBC</p>

<h2>Talk to a Personal Injury Lawyer who knows how to deal with ICBC</h2>

<p>Seeking compensation for your injuries can be a complicated process, and it's a process you shouldn't try to do yourself. You should not make any decisions, including talking to an ICBC adjuster, without being completely aware of your rights. A personal injuryjhj lawyer can tell you what those rights are.</p>

<p>A lawyer will handle the process of your claim. Your lawyer will also make sure that the proper claim forms are submitted to ICBC. A lawyer will properly investigate your claim, and compile the necessary medical documentation needed to support your claim. If necessary, they will start the lawsuit process within the allotted time limits. A lawyer is especially important to have when you are dealing with insurance companies.</p>

<h2>Dealing with ICBC (The Insurance Corporations of British Columbia)</h2>

<p>Insurance companies, like ICBC, have lawyers, and you should have one too. If not, you're a great disadvantage; and they know it!</p>

<p>Usually, ICBC will have you meet with one of their adjusters to speak with you about the accident and the injuries you sustained from it. Here are some important points to remember when you meet with the adjuster;
<ul>
	<li>The adjuster works for ICBC, not you.</li>
...
<h2>Find out if you have a car accident injury claim, and how much it's worth</h2>
