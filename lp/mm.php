...
$title = $city." personal injury lawyers for medical malpractice  and medical negligence claims.";

$metaDesc =  $city." personal injury lawyers will maximize your claim for medical malpractice or medical negligence injuries.";
...
<h2><?= $city; ?></h2>
    ...
    <script type="text/javascript">insertVideoPlayer( "/videoPlayer/videoPlayer.swf", 350, 300, "../videos/lp/mm_<?= $city; ?>.flv", "000000", false, "/images/playVideo.png", "/images/pauseVideo.png" );</script>
...
<div class="leftContent">
  ...
  <h1><?= $city; ?> Medical Malpractice and Negligence Injury Lawyers</h1>
	
<p>Have you been injured in <?= $city; ?> as the result of medical malpractice or medical negligence? If so, you need to talk to a personal injury lawyer immediately.</p>

<p>Health care providers, like doctors and nurses, are human. No one expects them to be perfect. But sometimes they make mistakes that shouldn't have been made. Negligent mistakes that can cause serious injuries and suffering to the people they are charged with treating.</p>

<p>If you've received medical treatment, and you believe that you've been injured through that treatment, contact a personal injury lawyer and tell them about it.</p>
...
<p>Our <?= $city; ?> lawyers can help you determine if you have a medical malpractice or medical negligence claim, and lead you through your pursuit for compensation. You may be entitled to compensation for pain and suffering, loss of income, health care expenses, housekeeping costs and any other economic losses incurred.</p>
