<?php
define("BASE_URL","http://divorcefamilylaw.ca/");
define("BASE_MASTER_URL","http://justcharged.com/");
...
//$keywords = $db->arrayFromQuery("SELECT * FROM keywords ORDER BY RAND() LIMIT 12",",");
?>
