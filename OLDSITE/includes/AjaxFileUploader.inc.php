...
class AjaxFileuploader {
	...
	public function showFileUploader($uploaderId) {
		if (in_array($uploaderId, $this->uploaderIdArray)) {
			...
			return '<div style=" height:40px;"><form id="formName'.$uploaderId.'" method="post" enctype="multipart/form-data" action="imageupload.php?dirname='.$this->uploadDirectory.'" target="iframe'.$uploaderId.'">
						...
						<iframe name="iframe'.$uploaderId.'" src="imageupload.php?uid='.$uploaderId.'" width="400" height="100" style="display:none"> </iframe>
					</form></div>';
		}
	}
}
